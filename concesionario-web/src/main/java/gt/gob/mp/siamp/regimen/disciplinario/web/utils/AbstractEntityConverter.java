package gt.gob.mp.siamp.regimen.disciplinario.web.utils;
 ...
 *
 * @FacesConverter(value = "genericEntityConverter") y adicionalmente se debe
 * implementar el metodo abstracto getEntityManager()
 *
 * @author kaguilar
 */
